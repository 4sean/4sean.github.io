...
```
<!-- ![自适应两栏布局](https://github.com/4sean/4sean.github.io/tree/master/pages/images/自适应两栏布局.gif "自适应两栏布局") -->
### 2.圣杯布局和双飞翼布局
...
6. 效果图
<!-- ![三栏布局](https://github.com/4sean/4sean.github.io/tree/master/pages/images/圣杯布局.gif "三栏布局") -->
